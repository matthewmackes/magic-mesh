...
impl<'a> Node<'a> {
    ...
    pub fn to_writer<W: Write>(&self, writer: W) -> Result<()> {
        ...
        // quick-xml 0.41 returns WriteResult + SeError; keep the public
        // Result<()> and map serialize failures into the existing QuickXml arm.
        let _ = to_writer(Writer(writer), &self)?;

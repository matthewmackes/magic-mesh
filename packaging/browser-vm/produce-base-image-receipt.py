#!/usr/bin/env python3
"""Produce and revalidate the governed Browser VM base-image receipt."""
...
KIND = "mcnf-browser-vm-base-image-receipt"
MEDIA_TYPES = {
...
def publish(path: Path, payload: bytes) -> None:
    ...
    fd, temporary = tempfile.mkstemp(prefix=".browser-base.", dir=path.parent)
    try:
        os.fchmod(fd, 0o400)
...
def main() -> int:
    try:
        ...
        print(f"browser-base-image-receipt: REFUSED: {exc}", file=sys.stderr)
        return EXIT_REFUSED

...
# mesh-storage image catalog via `mackesd images --record`.
#
...
# mackesd's local state + the replicated mesh-storage dir. Identity and
# enrollment are provided at run time (bind-mounted creds / env), never

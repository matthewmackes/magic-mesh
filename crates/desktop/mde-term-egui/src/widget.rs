...
pub struct TerminalWidget {
    ...
    cursor_shape: CursorShape,
    /// The active content colour scheme (TERM-11): Construct default or a preset.
    palette: Palette,
...
impl TerminalWidget {
    ...
    /// The active content colour scheme — the Construct default or a preset (TERM-11).
    #[must_use]
    ...
    pub fn show(&mut self, ui: &mut Ui) -> Response {
        ...
        // Intel One Mono face first in the Monospace family, so this `FontId`
        // resolves to it.
...
mod tests {
    ...
    fn a_preset_palette_repaints_the_content_into_the_primitives() {
        ...
        // The Construct default's content red is gone — this is genuinely the

...
//! control plane, no desktop) · `Workstation` (the full Quazar egui thin
...
/// relay / control plane) · **Workstation** (the full Quazar egui thin
...
pub enum Role {
    ...
    /// VPS-friendly.
    Lighthouse,
    /// Full workstation — the Quazar stack: the egui-DRM shell + VDI +

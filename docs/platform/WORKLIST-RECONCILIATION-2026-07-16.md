...
| E12/OW text still mentioned cloud-hypervisor while governance and Quasar Cloud docs say Nova/libvirt/QEMU-KVM. | Active items reference the Nova/libvirt/QEMU-KVM stack; old cloud-hypervisor text is historical. |
...
- Live Quasar Cloud resource create/delete on farm/dev cloud.
...
5. WL-ARCH-001, WL-ARCH-002, and WL-TEST-001 - Finish Quasar Cloud hard cutover,

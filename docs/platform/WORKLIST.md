...
- Current state: dests exist at `/root/mcnf-private/bootstrap-ssh-key` (0600) and
  ...
  until dest-backed candidate admit (13.0.0 NEVRA; governed GPG; absent dest still refuse). Seat 15 enrolled.
  ...
  `WL-FUNC-023-2026-08-22-bootstrap-env-run-r1.md`, dest-env strip r1, candidate dest GPG r1.

...
- **Files route hard-cut (2026-08-15):** standalone `Surface::Files` now normalizes into canonical Communications Files mode and cannot render as a duplicate top-level route. BigBoy passed the targeted legacy-route test 1/1: `evidence/WL-FUNC-011-2026-08-15-files-route-hard-cut-r1.md`.
- Remaining work:

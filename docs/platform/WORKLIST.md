...
- Current state: dests exist at `/root/mcnf-private/bootstrap-ssh-key` (0600) and
  ...
  until dest-backed candidate admit; production mutation then runs seat-update-warning. Seat 15 enrolled.
  ...
  `WL-FUNC-023-2026-08-22-bootstrap-env-run-r1.md`, dest-env strip r1, seat-warning r1.

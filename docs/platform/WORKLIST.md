...
- Current state: dests exist at `/root/mcnf-private/bootstrap-ssh-key` (0600) and
  ...
  sources dests; enroll/offboard/join argv refuse (login env unset). Mint helper
  ...
  `WL-FUNC-023-2026-08-22-bootstrap-env-run-r1.md`, mint-dest + run-mutation refuse r1.

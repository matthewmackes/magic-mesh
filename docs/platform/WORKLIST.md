...
- **Cast adapter, discovery, and command dispatch (2026-08-15):** `mde-musicd` now owns a bounded numeric-address Cast target, bounded DIAL identity parser, CASTV2 TLS/protobuf seam, and blocking default-media-receiver load/play/pause/seek dispatch using `rust_cast`; focused farm tests pass 9/9 including live connection and media load/pause. The reachable Xiaomi MIBOX4 proof is recorded in `evidence/WL-FUNC-021-2026-08-15-cast-target-availability-r1.md`; renderer ownership commit remains.

...
- Current state: dests exist at `/root/mcnf-private/bootstrap-ssh-key` (0600) and
  ...
  sources dests; enroll/offboard/join argv refuse; power-cycle and magic-setup stream strip dest env.
  ...
  `WL-FUNC-023-2026-08-22-bootstrap-env-run-r1.md`, dest-env strip r1 (power-cycle + stream).

...
## Wave 3 — session drain closures (2026-07-19)

Landed/proven this session and moved out of the active worklist. Commit refs + parked live tails inline.

### WL-ARCH-003 - Shared Bus/Persist client seam and wire-contract fixtures

- Disposition: DONE (landed e2b9ea4e: remaining shell reader surfaces migrated onto BusReader + latest-value helpers + wire fixtures)
- Priority: P2
- Complexity: Large
...
- Disposition: DONE (landed c0857fc2: unified worker registration into ONE declarative WORKER_REGISTRY; drift now structurally impossible)
- Priority: P2
- Complexity: Epic
...
- Disposition: DONE (landed ed456387: promotion rollback verb + non-prod drill + runbook; secret-scan sub-item operator-deferred)
- Priority: P1
- Complexity: Medium
...
- Disposition: DONE (landed ad44f1ed: 24 design-doc supersession banners + doc-supersession lint)
- Priority: P2
- Complexity: Medium
...
- Disposition: DONE (landed ad44f1ed: NEEDS-OPERATOR re-keyed to WL-* + reframed as a subordinate sink)
- Priority: P2
- Complexity: Small
...
- Disposition: DONE (landed ad44f1ed: worklist stewardship lifecycle across WORKLIST header + AGENTS.md + archive README)
- Priority: P3
- Complexity: Small
...
- Disposition: DONE (landed 39d4ddba: deterministic two-store session-sync convergence fixture)
- Priority: P2
- Complexity: Large
...
- Disposition: DONE (landed 37c7834e, operator-scoped: health-weighted mesh search ranking + enforced ephemeral/local-only search privacy; persistent index + external AI scoped OUT)
- Priority: P2
- Complexity: Large
...
- Disposition: CODE-DONE + PARKED (VDI session bottom-rail + shared file-op progress complete; live .15 rail screenshot seat-gated — on the operator verify list)
- Priority: P1
- Complexity: Medium
...
- Disposition: DONE (landed 99475869: unified ServiceRecord aggregator — provenance/health/TTL — + shell Services tab)
- Priority: P2
- Complexity: Medium
...
- Disposition: CODE-DONE + PARKED (landed 643ac7d7: per-frame repaint while VDI transport live so idle seat wakes; optional live-seat VDI-wake proof)
- Priority: P2
- Complexity: Medium
...
- Disposition: DONE (landed 0f15faa2: reconcile/drift/bus-error observability counters + exporter)
- Priority: P2
- Complexity: Medium
...
- Disposition: DONE-LIVE (2026-07-19 drill: media service validated live — active-active music.mesh + single writer + upload path; node-outage failover design-verified, not force-tested for 2-LH quorum safety)
- Priority: P1
- Complexity: Large
...
- Disposition: CODE-DONE + PARKED (landed 8a9f949d: per-appliance router mutation verb w/ typed-confirm + commit-confirm auto-revert + hash-chain audit + Device Manager panel; live-router smoke operator-gated)
- Priority: P2
- Complexity: Medium
...
- Disposition: DONE-LIVE (2026-07-19 drill: .15 fresh-node leave+enroll proven live — overlay 10.42.0.8, boot-durable, survives reboot, overlay ping OK)
- Priority: P1
- Complexity: Medium
...
- Disposition: DONE (landed 0b7675a3: cross-mesh federation runtime enforcement — grant-gated routing default-deny, cert-install-on-accept, GUI accept/refuse, two-identity harness)
- Priority: P1
- Complexity: Large
...
- Disposition: CODE-DONE + PARKED (landed 52655924: role/scope-targeted sealing — cryptographic recipient-set exclusion; live 2-node decrypt needs 2nd node + DO creds)
- Priority: P1
- Complexity: Large
...
- Disposition: DONE (landed 3d422e07: seated-user arm/disarm consent publisher to ARM_TOPIC + Phones-hub card)
- Priority: P1
- Complexity: Medium
...
- Disposition: CODE-DONE + PARKED (landed 19bc4559: OpenStack create/verify/delete harness w/ cleanup-on-failure + farm lane; live RUN gated on a farm OpenStack endpoint that does not exist)
- Priority: P1
- Complexity: Medium
...
- Disposition: CODE-DONE + PARKED (landed 324423fa: crown-jewel etcd/Nebula live-harness skeleton + fail-loud farm-runner wrapper + docs; live RUN needs live etcd/Nebula infra)
- Priority: P1
- Complexity: Large
...
- Disposition: CODE-DONE + PARKED (landed fbb3ecf8: single launcher — legacy Start Menu removed, pins migrated — + security-allowlisted peer-app remote exec; live .15 visual seat-gated)
- Priority: P2
- Complexity: Epic

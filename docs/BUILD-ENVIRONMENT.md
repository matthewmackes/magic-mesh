...
| `XEN-BIGBOY` | `172.20.145.165` | XCP-ng 8.3 dom0 | **12c / 32 GiB** | hypervisor — build VM `mcnf-build-52` (reachable `172.20.0.130`, **12 vCPU / 20 GiB** — resized 2026-06-28 to use the full 12-core host); 398 GiB SR; the high-capacity node — **3 heavy slots** |

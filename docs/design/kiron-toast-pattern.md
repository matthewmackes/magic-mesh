...
| 6 | Dwell | **Five-second dwell for Info and Warning; until-acknowledged for Critical**; **hover pauses** the countdown; click-action or dismiss-"X"/swipe removes now; a Critical requires explicit **acknowledge**. Motion-table slide in/out (FAST/BASE). |

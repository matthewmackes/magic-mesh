...
> **Series:** opens **MCNF 12.0** (current tip: 11.2.0). Codename **"Construct"**
...
| 8 | **Identity** | **Evolve MCNF → 12.0 series** (codename proposed "Construct"); package/repo id stays `magic-mesh`. The "C" in MCNF now means *our forked Cosmic*, not *runs on Cosmic*. |
...
```
                         MCNF 12.0 "Construct" — one repo, three tiers
  ┌─────────────────────────────────────────────────────────────────────┐
...
- **Codename for the 12.0 series.** **Confirmed "Construct"** (operator, 2026-06-30).

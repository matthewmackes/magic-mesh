...
PATH_FIELDS = {
    ...
    "maps_verifier",
    "app_vm_catalog_trust_receipt",
    "app_vm_catalog_trust_key",
...
ARGUMENTS = (
    ...
    ("app_vm_catalog_trust_receipt", "--app-vm-catalog-trust-receipt"),
    ("app_vm_catalog_trust_key", "--app-vm-catalog-trust-key"),
    ("cuttlefish_declaration", "--cuttlefish-declaration"),
    ("cuttlefish_signature", "--cuttlefish-signature"),
